...
pub use message::{
    ...
    SetPropertyResponse, SetPropertyStatus, ShutdownRequest, ShutdownResponse, decode_adapter_line,
    decode_request_line, encode_event_line, encode_request_line, encode_response_line,
};
pub use protocol::{
